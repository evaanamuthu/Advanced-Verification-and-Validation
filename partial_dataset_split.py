...
nor_x_train=pd.read_csv(f"D:/master thesis/dataset/train/partial_df_norm_x_train.csv")
nor_x_train=nor_x_train.values.reshape(4232,-1)

nor_x_test=pd.read_csv(f"D:/master thesis/dataset/test/partial_df_norm_x_test.csv")
...
bc_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/bc_norm_cm.png")
# plt.show()
plt.close()
...
bc_DTree_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/bc_DTree_norm_cm.png")
# plt.show()
plt.close()
...
bbc_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/bbc_norm_cm.png")
# plt.show()
plt.close()
...
bbc_DTree_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/bbc_DTree_norm_cm.png")
# plt.show()
plt.close()
...
EEC_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/EEC_norm_cm.png")
# plt.show()
plt.close()
...
rusboost_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/rusboost_norm_cm.png")
# plt.show()
plt.close()
...
BRF_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/BRF_norm_cm.png")
# plt.show()
plt.close()
...
rot_for_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/rot_for_norm_cm.png")
# plt.show()
plt.close()
...
DrCIF_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/DrCIF_norm_cm.png")
# plt.show()
plt.close()
...
c22_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/c22_norm_cm.png")
# plt.show()
plt.close()
...
bc_resa_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/bc_resa_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/bc_DTree_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/bbc_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/bbc_Dec_Tree_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/eec_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/rusboost_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/BRF_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/rot_for_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/DrCIF_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/dataset_split/partial/c22_resampled_norm_cm.png")
# plt.show()
plt.close()
...
result_df.to_csv("D:/master thesis/dataset/dataset_split/partial/result_data_split_norm_partial_df.csv",index=False)
...
# plt.legend()
# plt.legend(loc='best')
plt.savefig('D:/master thesis/dataset/dataset_split/partial/nor_ROC.png',dpi=300)
plt.show()
