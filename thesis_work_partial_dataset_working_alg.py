...
y_train = pd.read_csv("D:/advanced verification and validation/partial_df_y_train.csv")
# x_train=x_train.drop(['filename'],axis=1)
y_train=y_train.values.reshape(-1,1)
y_train=np.squeeze(y_train)

y_test = pd.read_csv("D:/advanced verification and validation/partial_df_y_test.csv")
# x_test=x_test.drop(x_test.iloc[:,3002],axis=1)
y_test=y_test.values.reshape(-1,1)

x_train=pd.read_csv("D:/advanced verification and validation/partial_df_norm_x_train.csv")
x_train=x_train.values.reshape(4230,-1)

x_test=pd.read_csv("D:/advanced verification and validation/partial_df_norm_x_test.csv")
x_test=x_test.values.reshape(1059,-1)
...
bc_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/bc_norm_cm.png")
# plt.show()
plt.close()
...
bc_DTree_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/bc_DTree_norm_cm.png")
# plt.show()
plt.close()
...
bbc_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/bbc_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/bbc_Dec_Tree_norm_cm.png")
# plt.show()
plt.close()
...
EEC_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/EEC_norm_cm.png")
# plt.show()
plt.close()
...
rusboost_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/rusboost_norm_cm.png")
# plt.show()
plt.close()
...
BRF_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/BRF_norm_cm.png")
# plt.show()
plt.close()
...
rot_for_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/rot_for_norm_cm.png")
# plt.show()
plt.close()
...
DrCIF_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/DrCIF_norm_cm.png")
# plt.show()
plt.close()
...
c22_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/c22_norm_cm.png")
# plt.show()
plt.close()
...
bc_resa_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/partial/bc_resa_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/bc_DTree_resa_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/bbc_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/bbc_Dec_Tree_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/eec_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/rusboost_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/BRF_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/rot_for_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/DrCIF_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/partial/c22_resampled_norm_cm.png")
# plt.show()
plt.close()
...
result_df.to_csv("D:/master thesis/partial/result_norm_partial_df.csv",index=False)
...
# plt.legend()
# plt.legend(loc='best')
plt.savefig('D:/master thesis/partial/nor_ROC.png',dpi=300)
# plt.show()
plt.close()
