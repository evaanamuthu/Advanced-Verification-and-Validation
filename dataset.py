...
X_train.to_csv('D:/advanced verification and validation/dataset/df_x_train.csv',index=False)
X_test.to_csv('D:/advanced verification and validation/dataset/df_x_test.csv',index=False)
y_train.to_csv('D:/advanced verification and validation/dataset/df_y_train.csv',index=False)
y_test.to_csv('D:/advanced verification and validation/dataset/df_y_test.csv',index=False)

import numpy as np
nor_x_train=X_train/np.linalg.norm(X_train, axis=1, keepdims=True)
print(nor_x_train)
nor_x_train.to_csv(f"D:/advanced verification and validation/dataset/df_norm_x_train.csv",index=False)

nor_x_test=X_test/np.linalg.norm(X_test, axis=1, keepdims=True)
print(nor_x_test)
nor_x_test.to_csv(f"D:/advanced verification and validation/dataset/df_norm_x_test.csv",index=False)
'''
...
y_train=pd.read_csv(f'D:/advanced verification and validation/dataset/df_y_train.csv')
y_test=pd.read_csv(f'D:/advanced verification and validation/dataset/df_y_test.csv')
...
nor_x_train=pd.read_csv(f"D:/advanced verification and validation/dataset/df_norm_x_train.csv")
nor_x_train=nor_x_train.values.reshape(4232,-1)

nor_x_test=pd.read_csv(f"D:/advanced verification and validation/dataset/df_norm_x_test.csv")
...
bc_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/bc_norm_cm.png")
# plt.show()
plt.close()
...
bc_DTree_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/bc_DTree_norm_cm.png")
# plt.show()
plt.close()
...
bbc_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/bbc_norm_cm.png")
# plt.show()
plt.close()
...
bbc_DTree_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/bbc_DTree_norm_cm.png")
# plt.show()
plt.close()
...
EEC_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/EEC_norm_cm.png")
# plt.show()
plt.close()
...
rusboost_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/rusboost_norm_cm.png")
# plt.show()
plt.close()
...
BRF_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/BRF_norm_cm.png")
# plt.show()
plt.close()
...
rot_for_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/rot_for_norm_cm.png")
# plt.show()
plt.close()
...
DrCIF_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/DrCIF_norm_cm.png")
# plt.show()
plt.close()
...
c22_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/c22_norm_cm.png")
# plt.show()
plt.close()
...
bc_resa_disp.plot()
# plt.show()
plt.savefig("D:/master thesis/dataset/bc_resa_cm.png")
# plt.show()
plt.close()
...
auc_score_bc_DTree_resampled=roc_auc_score(y_test,bc_DTree_resampled_y_pred)
...
print("bc_DTree_resampled_roc_auc:",bc_DTree_resampled_y_pred_proba)
...
# plt.show()
plt.savefig("D:/master thesis/dataset/bc_DTree_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/bbc_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/bbc_Dec_Tree_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/eec_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/rusboost_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/BRF_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/rot_for_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/DrCIF_resampled_norm_cm.png")
# plt.show()
plt.close()
...
# plt.show()
plt.savefig("D:/master thesis/dataset/c22_resampled_norm_cm.png")
# plt.show()
plt.close()
...
result_df.to_csv("D:/master thesis/dataset/result_data_split_norm_df.csv",index=False)
...
# plt.legend()
# plt.legend(loc='best')
plt.savefig('D:/master thesis/dataset/nor_ROC.png',dpi=300)
plt.show()
